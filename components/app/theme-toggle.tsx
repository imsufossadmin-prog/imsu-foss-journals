...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      {theme === "dark" ? (
        <svg aria-hidden="true" viewBox="0 0 20 20" fill="currentColor" className="size-4 text-emerald-400">
        ...
        <svg aria-hidden="true" viewBox="0 0 20 20" fill="currentColor" className="size-4 text-slate-700">
