        ...
        <div className="mt-6 space-y-4">
          {filteredUsers.map((user) => {
            ...
            return (
              <section
                key={user.id}
                className="rounded-[var(--radius-lg)] border border-[color:var(--color-border)] bg-[color:var(--color-surface-raised)] p-4 sm:p-5"
              >
                ...
                <form
                  action={assignAction}
                  className="mt-4 flex flex-col gap-3 border-t border-[color:var(--color-border)] pt-4 sm:flex-row sm:items-end"
                >
                  <input type="hidden" name="targetUserId" value={user.id} />
                  <label className="text-xs font-semibold text-[color:var(--color-subtle)] sm:w-48">
                    Role
                    <select
                      name="role"
                  ...
                  <label className="text-xs font-semibold text-[color:var(--color-subtle)] sm:flex-1">
                    Department / Journal
                    <select
                      name="journalId"
                      className="app-field mt-1"
                      defaultValue=""
                    >
                      <option value="">No department — Super Admin only</option>
