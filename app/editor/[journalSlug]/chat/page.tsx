...
export default async function EditorInternalChatPage({
  params,
}: {
        ...
        <div className="mt-3 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-xs text-[color:var(--color-subtle)]">
              Direct, private communication between Editors and Journal
              Administrators for {journal.name}.
            </p>
          </div>
