    ...
    <div className="mx-auto max-w-6xl">
      <header className="border-b border-[color:var(--color-border)] pb-8">
        ...
        <p className="mt-3 text-sm text-[color:var(--color-muted)]">
          Submitted research manuscripts for {journalLabel}, including papers
          awaiting tracking IDs and peer reviews.
        </p>
      </header>
      ...
      <div className="mt-7 overflow-hidden rounded-[var(--radius-lg)] border border-[color:var(--color-border)] bg-[color:var(--color-surface-raised)]">
        {submissions.length ? (
              ...
              >
                ...
                >
                  <div>
                    ...
                    <h2 className="mt-2 truncate text-sm font-semibold text-[color:var(--color-foreground)]">
          ...
          <div className="px-6 py-16 text-center text-sm text-[color:var(--color-muted)]">
            No submitted manuscripts match this view.
          </div>
        )}
      </div>
    </div>
